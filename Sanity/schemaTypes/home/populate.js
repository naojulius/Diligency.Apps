...
var home_text_default_1 = require("../../static/home-text.default");
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    data = {
                        hero: [__assign(__assign({}, home_text_default_1.HomeTextDefault.hero), { title: [home_text_default_1.HomeTextDefault.hero.title] // wrap title in array to match HeroTitle[]
                             })] // wrap object in array to match schema
                    };
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, client.createOrReplace(__assign({ _id: 'home', _type: 'home' }, data))];
                case 2:
                    _a.sent();
                ...
                case 3:
                    err_1 = _a.sent();
                    console.error('Error saving Home page:', err_1);
                    return [3 /*break*/, 4];
