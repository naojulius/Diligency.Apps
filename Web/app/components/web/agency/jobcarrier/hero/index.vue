            ...
            <div class="px-10 2xl:px-35 w-full h-full pt-20 flex items-center justify-center ">
                <div
                    ...
                    <h2 class="text-center text-xl text-secondary z-10">
                        Diligency est une structure hybride et agile, fondée sur l’excellence des indépendants qui la
                        composent.
                        Nous collaborons avec des talents freelance rigoureux, exigeants et autonomes — des
                        professionnels capables
                        de livrer proprement, de comprendre un projet sans blabla inutile et de proposer des solutions
                        cohérentes.
                    </h2>
                </div>
            </div>
