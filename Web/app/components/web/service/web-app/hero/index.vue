            ...
            <div class="px-10 2xl:px-35 w-full h-full pt-20 flex items-center justify-center ">
                <div
                    ...
                    <h1 id="hero"
                        ...
                        <span>
                            Applications Web & Plateformes métier
                            Construisons l'efficacité digitale
                        </span>
                    </h1>
                    <h2 class="text-center text-xl text-secondary z-10">
                        Développement sur-mesure de plateformes digitales: dashboards, CRM, réservation, marketplace,
                        outils Saas.
                    </h2>
                </div>
            </div>
