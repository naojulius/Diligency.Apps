<template>
    <footer class="bg-black text-white py-16 px-4 md:px-10 2xl:px-35 flex flex-col w-full">
        <div class="w-full flex flex-col md:flex-row gap-4 md:gap-0 justify-between ">
            <WebFooterCompany />
            <WebFooterNavigation />
        </div>
        <WebFooterLocale />
