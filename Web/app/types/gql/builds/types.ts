...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetHeroDataQuery(variables?: GetHeroDataQueryQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetHeroDataQueryQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetHeroDataQueryQuery>({ document: GetHeroDataQueryDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetHeroDataQuery', 'query', variables);
    }
  };
}
