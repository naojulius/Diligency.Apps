...
export const SERVICE_DATA = {
    ...
    "it-ia": {
        ...
        footer: {
            type: "footer-a",
            text: {
                fr: "Chez Diligency, nous concevons des solutions IT et IA robustes et intelligentes pour automatiser, connecter et accélérer votre croissance digitale en toute confiance.",
                en: "At Diligency, we design robust, intelligent IT and AI solutions to automate, connect, and accelerate your digital growth with confidence."
            },
            cta: [
                {
                    icon: "lucide:",
